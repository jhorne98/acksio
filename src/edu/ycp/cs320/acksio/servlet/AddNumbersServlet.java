...
public class AddNumbersServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		Numbers model = new Numbers(getDoubleFromParameter(req.getParameter("first")), getDoubleFromParameter(req.getParameter("second")), getDoubleFromParameter(req.getParameter("third")));
